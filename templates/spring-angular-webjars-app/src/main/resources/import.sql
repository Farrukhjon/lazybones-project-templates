insert into user (first_name, last_name, email, password, role) values ('ali', 'valizoda', 'avalizoda@localhost', 'test', 0);
insert into user (first_name, last_name, email, password, role) values ('vali', 'valizoda', 'vvalizoda@localhost', 'pwd', 1);
insert into user (first_name, last_name, email, password, role) values ('sami', 'valizoda', 'svalizoda@localhost', 'secret', 2);
